...
def process_intent(intent_response, session, user_message, books, embedding_model, book_embeddings):
    try:
        ...
        if intent == 'RECOMMEND':
            ...
            filtered_books = nlp_filter_books(topic, books, embedding_model, book_embeddings, top_n=5)
...
def call_borrow_return_function(session, user_message):
    return "Borrow/Return functionality is not implemented yet."
